public class Prints 
{
    public static void ChoicePrints() 
    {
        ...
        System.out.println("4: If you wish to draw a Sac Card.");
        System.out.println("5: If you wish to know how many Sacrifice Cards you have left.");
        System.out.println("6: If you wish to end the program.");
    }
